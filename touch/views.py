...
def domain(request):
    ...
    data = "Ask me Anything About "+input
...
def predict(request):
    if request.method == 'POST':
        ...
        if prob.item() > 0.75:
            ...
            output = "Hmm, sorry, I don't quite understand that. please contact IPW L3 team for more information."
